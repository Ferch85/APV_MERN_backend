...
const registrar = async (req, res) => { 
    ...
    try {
        ...
        //Enviar el email antes de enviar respuesta
        emailRegistro({
            email,
            nombre,
...
const confirmar = async (req, res) => {
    //req.params.token LEE LOS PARAMETROS ENVIADOS POR URL:
...
const nuevoPassword = async (req, res) => {
    ...
    try {
        //se asigna el nuevo password y se quita el token
...
//Se usan llaves en export cuando se exportan multiples funciones
export {
